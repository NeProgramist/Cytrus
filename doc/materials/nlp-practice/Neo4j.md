...
Цей модуль надає загальний інтерфейс для основних текстових процесорів, так само як Domain Specific Language, побудований на збережені процедур та функцій, що сприяє полегшенню життя розробнику робочого процесу з обробки природних мов.
