...
Для користувача - СПЗ, має бути реалізовна стороння restful api, яка буде надавати можливість надсилати запроси у Cytrus та отримувати результат роботи програми. Версія для СПЗ має ще 2 підверсії розширена(за кошти) та стандартна (безкоштовна)

##### Стандартна

Обробка текстів не більше, ніж 250 слів.
Кількість зв'язків не перевищує 3х.

##### Розширена

Обробка текстів будь-якої довжини.
До 9 зв'якзів.
